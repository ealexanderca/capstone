...
## DataRecording.py
Running this script will allow you to record raw data from a Labjack and sound froma microphone on  a windows PC. Refer to the comments for more information.
